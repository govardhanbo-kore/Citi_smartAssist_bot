...
/** ======== 09-06-2022 Custom Code added for CITI POC for getting browser and device details ============  */
                /** citi testing Browser information  */    
                ...
                if ((verOffset=nAgt.indexOf("Opera"))!=-1) {
                    KoreSDK.chatConfig.browserName = "Opera";
                }
                // In MSIE, the true version is after "MSIE" in userAgent
                else if ((verOffset=nAgt.indexOf("MSIE"))!=-1) {
                    KoreSDK.chatConfig.browserName = "Microsoft Internet Explorer";
                }
                // In Chrome, the true version is after "Chrome" 
                else if ((verOffset=nAgt.indexOf("Chrome"))!=-1) {
                    KoreSDK.chatConfig.browserName = "Chrome";
                }
                // In Safari, the true version is after "Safari" or after "Version" 
                else if ((verOffset=nAgt.indexOf("Safari"))!=-1) {
                    KoreSDK.chatConfig.browserName = "Safari";
                }
                // In Firefox, the true version is after "Firefox" 
                else if ((verOffset=nAgt.indexOf("Firefox"))!=-1) {
                    KoreSDK.chatConfig.browserName = "Firefox";
                }
                // In most other browsers, "name/version" is at the end of userAgent 
                else if ( (nameOffset=nAgt.lastIndexOf(' ')+1) < 
                            (verOffset=nAgt.lastIndexOf('/')) ) 
                {
                    KoreSDK.chatConfig.browserName = nAgt.substring(nameOffset,verOffset);
                }
                
                
                KoreSDK.chatConfig.OSName="Unknown OS";
                if (navigator.appVersion.indexOf("Win")!=-1) KoreSDK.chatConfig.OSName="Windows";
                if (navigator.appVersion.indexOf("Mac")!=-1) KoreSDK.chatConfig.OSName="MacOS";
                if (navigator.appVersion.indexOf("X11")!=-1) KoreSDK.chatConfig.OSName="UNIX";
                if (navigator.appVersion.indexOf("Linux")!=-1) KoreSDK.chatConfig.OSName="Linux";
    ...
    this.screenShare = function(data) {
        ...
        return p.then(() => {
                ...
                return _self.activeCall.startScreenSharing(_self.screenSharingStream);    
            }).catch((e) => {
