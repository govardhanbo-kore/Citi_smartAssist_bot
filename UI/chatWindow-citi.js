        ...
        function updateOnlineStatus() {
            ...
            chatWindow.prototype.destroy = function () {
                ...
                if (me.config && me.config.chatContainer) {
                    if (!me.config.minimizeMode) {
                        ...
                        me.config.chatContainer.find('.kore-chat-header .header-title .assistantName').html(me.config.botMessages.reconnecting);
            ...
            chatWindow.prototype.bindEvents = function () {
                ...
                _chatContainer.draggable({
                    handle: _chatContainer.find(".kore-chat-header .header-title .assistantName"),
            ...
            chatWindow.prototype.bindSDKEvents = function (){
                ...
                me.bot.on("message", function (message) {
                    ...
                    if (tempData.from === "bot" && tempData.type === "events") {
            ...
            chatWindow.prototype.onBotReady = function (){
                ...
                var _chatInput = _chatContainer.find('.kore-chat-footer .chatInputBox');
                _chatContainer.find('.kore-chat-header .header-title .assistantName').html(me.config.chatTitle).attr('title', me.config.chatTitle);
            ...
            chatWindow.prototype.sendMessage = function (chatInput, renderMsg,msgObject) {
                ...
                // $('.chat-container').append('<li class="fromOtherUsers with-icon removeLoaderLi"><div aria-hidden="true"  aria-live="off" class="profile-photo" style="background-image:url(https://dlnwzkim0wron.cloudfront.net/f-72793db0-f17a-5206-b248-b8b1318209da.png)"> <div title="User Avatar"></div> </div><div class="messageBubble loaderBubble"><lottie-player class="user-account avtar" src="https://assets1.lottiefiles.com/packages/lf20_hosioakx.json" background="transparent" style="width: 29px; height: 12px;" speed="1" loop autoplay></lottie-player></div> </li>');
            };
            ...
            chatWindow.prototype.renderMessage = function (msgData) {
                ...
                if (msgData.type === "bot_response") {
                    ...
                    // $('.chat-container .removeLoaderLi').remove();
                    setTimeout(function () {
                ...
                <div class="footerIonsContainer">\
                    ...
                    <div class="sdkFooterIcon ttspeakerDiv ttsOff"> \
                        <button class="ttspeaker" title="Talk to speak"> \
                            ...
                            <span style="display:none;"><audio id="ttspeaker" controls="" autoplay="" name="media"> \
            ...
            var chatWindowTemplate = '<script id="chat_window_tmpl" type="text/x-jqury-tmpl"> \
                ...
                <div class="kr-wiz-menu-chat defaultTheme-kore">\
                    ...
                    <div id="botHeaderTitle" aria-labelledby="botHeaderTitle" class="header_title" >\
                        <img src="https://asia.citi.com/askciti_emb/images/citi-logo.png" />\
                        <span class="assistantName">Ask Citi</span>\
                    </div> \
                    ...
                    <div class="typingIndicatorContent"><div class="typingIndicator"></div><div class="loaderBubble"><lottie-player class="user-account avtar" src="https://assets1.lottiefiles.com/packages/lf20_hosioakx.json" background="transparent" style="width: 29px; height: 12px;" speed="1" loop autoplay></lottie-player></div></div> \
                    <div class="kore-chat-footer disableFooter">' + chatFooterTemplate + '{{if isSendButton}}<div class="sendBtnCnt"><button class="sendButton disabled" type="button"><img class="submit-button" src="https://asia.citi.com/askciti_emb/images/enter.png" alt="send Button"></button></div>{{/if}}</div> \
                        ...
                        {{each(key, msgItem) msgData.message}} \
                            {{if msgItem.cInfo && msgItem.type === "text"}} \
                                <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                                    ...
                                    {{if msgData.createdOn}}<div aria-hidden="true" aria-live="off" class="extra-info hide">${helpers.formatDate(msgData.createdOn)}</div>{{/if}} \
                                    {{if msgData.icon}}<div aria-hidden="true"  aria-live="off" class="profile-photo"> <div class="user-account avtar" style="{{if msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type && msgData.message[0].component.payload.template_type == "live_agent"}}background-image:url('+agentIcon+'){{else}}background-image:url(${msgData.icon}){{/if}}" title="User Avatar"></div> </div> {{/if}} \
                                    <div class="messageBubble">\
                                        ...
                                        {{if msgItem.cInfo && msgItem.cInfo.emoji}} \
                                            <span class="emojione joypixels-24-people._${msgItem.cInfo.emoji[0].code}">${msgItem.cInfo.emoji[0].title}</span> \
                                        {{/if}} \
                ...
                {{if msgData.message}} \
                    {{each(key, msgItem) msgData.message}} \
                        {{if msgItem.component && msgItem.component.payload.url}} \
                            <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                                class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} {{if msgData.icon}}with-icon{{/if}}"> \
                                {{if msgData.createdOn}}<div class="extra-info hide">${helpers.formatDate(msgData.createdOn)}</div>{{/if}} \
