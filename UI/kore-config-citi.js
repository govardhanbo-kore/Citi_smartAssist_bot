(function(KoreSDK){
    ...
    // botOptions.userIdentity = 'test@kore.com';// Provide users email id here
    // botOptions.botInfo = { name: "Citi Assist", "_id": "st-a94d5401-8c75-5936-9ad2-9e7a5d4d4d36",customData: {fullName: fullName}}; // bot name is case sensitive
    // botOptions.clientId = "cs-077a1553-2177-55a6-8b68-b148f548e745";
    // botOptions.clientSecret = "QR818zjb83RETdGNulaan0pwiltRvCWFZxloYChqXGc=";


    /** UAT  smartAssist */
    botOptions.botInfo = { name: "Bot3105", "_id": "st-c65a7f57-3513-522d-9a4a-8e3abca318c1",customData: {fullName: fullName}}; // bot name is case sensitive
    botOptions.clientId = "cs-a7a0c5a8-9144-506c-b804-d052be9a6b1d";
    botOptions.clientSecret = "REAr40SHWhqHTU9hT/Cj15M5sukFhdAOrZp4l2krROM=";
